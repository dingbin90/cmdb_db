    ...
    def get(self,request,*args,**kwargs):
        table_config =[
            ...
            },
            {
                ...
                'attrs': {'name':'idc_id','origin':'@idc_id','edit-enable': 'true', 'edit-type': 'select','global-name':'idc_choices'}
            },
            #
            # {
            #     'q': "device_type_id",
            ...
            },
            {
                ...
                'title': "操作",
                'display': True,
                'text': {'content': "<button type='button' class='btn btn-default'><a href='/cmdb/asset/detail/{m}'>{n}</a></button>", "kwargs": {"n": "查看详细","m":"@id"}},
                'attrs': {}
            },
        ]
